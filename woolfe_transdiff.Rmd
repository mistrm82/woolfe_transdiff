...
## Enrichment Analysis
For each of the three gene lists we can identify over-represented terms to get an idea of what biological processes are regulated. This was done using [GOstats](http://www.bioconductor.org/packages/release/bioc/html/GOstats.html), a Bioconductor package in R. The associated Excel spreadheets for each of the three gene lists are listed below:        

* MEFvDRG: [GO report](./results/GOStats/MEFvsDRG_GOresults.xls) 
* MEFvsiNoc: [GO report](./results/GOStats/MEFvsiNoc_GOresults.xls) 
* iNocvsDRG: [GO report](./results/GOStats/iNocvsDRG_GOresults.xls) 
...
for (g in 2:3){
  ...
  listOfParamObjs <- list("BP"=GOparams, "MF"=paramsMF)
  
  # Run test
  resultGOList <- lapply(lisOfParamObjs, hyperGTest)
...
tf.background <- read.delim("tf_results", header=T, sep="\t", as.is=T)
